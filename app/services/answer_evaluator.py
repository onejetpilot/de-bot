                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "Всегда пиши feedback и weak_topics на русском языке, кроме кода, "
                            "SQL, команд и названий технологий."
                        ),
                    },
...
Критерии:
- все текстовые поля должны быть на русском языке, кроме кода, SQL, команд и названий технологий;
- score от 0 до 1;
